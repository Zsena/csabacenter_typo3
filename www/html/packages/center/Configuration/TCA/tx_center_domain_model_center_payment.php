...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:tx_center_domain_model_center_payment',
        'label' => 'text',
        'label_alt' => '',
        'label_alt_force' => '1',
        'tstamp' => 'tstamp',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_center_domain_model_center_payment.pid=###CURRENT_PID### AND tx_center_domain_model_center_payment.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
