...
return [
	'ctrl' => [
		'title' => 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:tx_center_domain_model_faqs',
		'label' => 'question',
		'label_alt' => 'question',
		'label_alt_force' => 0,
		'tstamp' => 'tstamp',
	...
	'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource,section_id, question, answer, center_id, hidden',
	],
	'types' => [
		'1' => ['showitem' => "section_id, question, answer, center_id, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,hidden,"],
	],
	'columns' => [
		'sys_language_uid' => [
			'exclude' => 1,
		...
		'section_id' => [
			...
			'config' => [
				...
				'foreign_table' => 'tx_center_domain_model_faqs_sections',
				'foreign_table_where' => 'tx_center_domain_model_faqs_sections.pid=###CURRENT_PID### AND tx_center_domain_model_faqs_sections.sys_language_uid=###REC_FIELD_sys_language_uid###',
				'minitems' => 1
			],
		],
		'question' => [
			'label' => 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:tx_center_domain_model_faqs.question',
			'config' => [
				'type' => 'input',
				'size' => 30,
				'max' => 255,
		...
		'answer' => [
			'label' => 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:tx_center_domain_model_faqs.answer',
			'config' => [
				'type' => 'text',
				'enableRichtext' => true,
