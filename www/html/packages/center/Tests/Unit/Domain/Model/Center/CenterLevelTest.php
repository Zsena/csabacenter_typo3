...
/**
 * Test case for class DigitalZombies\Center\Domain\Model\Center\CenterLevel.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class CenterLevelTest extends UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = GeneralUtility::makeInstance(CenterLevel::class);
	}
	 ...
	 * @test
	 */
	public function imageIsEmptyByDefault() {
