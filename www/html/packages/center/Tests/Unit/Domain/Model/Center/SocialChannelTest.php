...
use DigitalZombies\Center\Domain\Model\Center\SocialChannel;
use TYPO3\CMS\Core\Tests\UnitTestCase;
use TYPO3\CMS\Core\Utility\GeneralUtility;

/**
 * Test case for class DigitalZombies\Center\Domain\Model\Center\SocialChannel.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class SocialChannelTest extends UnitTestCase {
	/**
	 * @var \DigitalZombies\Center\Domain\Model\Center\SocialChannel
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = GeneralUtility::makeInstance(SocialChannel::class);
	}
