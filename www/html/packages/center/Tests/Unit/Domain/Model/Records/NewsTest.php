...
/**
 * Test case for class DigitalZombies\Center\Domain\Model\Records\News.
 *
...
class NewsTest extends UnitTestCase {
	/**
	 * @var \DigitalZombies\Center\Domain\Model\Records\News
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = GeneralUtility::makeInstance(News::class);
	}
