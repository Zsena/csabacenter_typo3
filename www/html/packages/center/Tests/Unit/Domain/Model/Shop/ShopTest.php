...
class ShopTest extends UnitTestCase {
	...
	protected function setUp() {
		$this->subject = GeneralUtility::makeInstance(Shop::class);
	}
	 ...
	 * @test
	 */
	public function chainStoreIsEmptyByDefault() {
		$this->assertEquals(null, $this->subject->getChainStore());
	}

	/**
	 * @test
	 */
	public function positionsInitializedByDefault() {
		$positions = $this->subject->getPositions();
		$this->assertEquals(ObjectStorage::class, get_class($positions));
		unset($positions);
	}
}
