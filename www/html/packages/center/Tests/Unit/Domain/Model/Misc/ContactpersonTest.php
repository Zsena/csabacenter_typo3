 ...
 *
 */
class ContactpersonTest extends UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = GeneralUtility::makeInstance(Contactperson::class);
	}
	 ...
	 * @test
	 */
	public function firstNameIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getFirstName());
	}

	/**
	 * @test
	 */
	public function lastNameIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getLastName());
	}
	 ...
	 * @test
	 */
	public function functionIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getFunction());
	}
	...
	public function emailIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getEmail());
	}
	 ...
	 * @test
	 */
	public function websiteIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getWebsite());
	}

	/**
	 * @test
	 */
	public function globalIsZeroByDefault() {
		$this->assertEquals(0, $this->subject->getGlobal());
	}

	/**
	 * @test
	 */
	public function companyNameIsBlankByDefault() {
		$this->assertEquals('', $this->subject->getCompanyName());
	}
