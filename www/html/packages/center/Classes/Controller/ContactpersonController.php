...
class ContactpersonController extends ActionController
{
	...
	/**
	 * Renders the basic structure for the contactperson
	 *
	 */
	public function showAction() {
		if(isset($this->settings['contactperson']['contactperson'])) {
			$contactperson = $this->contactpersonRepository->findByUid((int)$this->settings['contactperson']['contactperson']);
