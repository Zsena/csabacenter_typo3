...
class InterestHelper
{
	 ...
	 * @return void
	 */
	public static function enhanceWithInterest($tableName, array $options = [], $fieldName = 'tags', $typeName = '') {
	...
	protected static function registerColumn($tableName, array $options, $fieldName = 'tags', $typeName = '') {
		...
		if(isset($options['overrideLabel'])
			...
			$label = 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:general.interests';
		}
		...
		$columns = [
			$fieldName => [
				'label' => $label,
                'pnpu_description' => [
                    'label' => 'LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:general.interests.infoText',
				...
				'config' => [
					...
					'foreign_table_where' => " AND tx_center_domain_model_interest_interest.sys_language_uid IN (-1,0) ORDER BY tx_center_domain_model_interest_interest.sorting ASC",
	...
	protected static function addTaggingTab($fieldName, $options)
	{
		if(isset($options['withoutTab'])
			...
			return '--div--;LLL:EXT:center/Resources/Private/Language/locallang_db.xlf:general.tabs.interests, ' . $fieldName;
		}
	}
}