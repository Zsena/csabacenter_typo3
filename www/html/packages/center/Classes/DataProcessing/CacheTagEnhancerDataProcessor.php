...
/**
 * Class CacheTagEnhancerDataProcessor
 * @package DigitalZombies\Center\DataProcessing
 */
class CacheTagEnhancerDataProcessor implements DataProcessorInterface
{
    ...
    public function process(ContentObjectRenderer $cObj, array $contentObjectConfiguration, array $processorConfiguration, array $processedData)
    {
		if(ScopeConfiguration::hasCenter()) {
			$cObj->stdWrap_addPageCacheTags('', [
				'addPageCacheTags' => 'pageId_' . ScopeConfiguration::getScope()->getPageId()
			]);
		}
