...
$GLOBALS['SiteConfiguration']['site']['columns']['solr_username_read'] = [
    'label' => 'Username',
    'config' => [
        'type' => 'input',
        'eval' => 'trim'
...
$GLOBALS['SiteConfiguration']['site']['columns']['solr_password_read'] = [
    'label' => 'Password',
    'config' => [
        'type' => 'input',
        'eval' => 'trim'
...
$GLOBALS['SiteConfiguration']['site']['columns']['solr_timeout_read'] = [
    'label' => 'Timeout',
    'config' => [
        'type' => 'input',
        'eval' => 'trim'
...
$GLOBALS['SiteConfiguration']['site']['columns']['solr_username_write'] = $GLOBALS['SiteConfiguration']['site']['columns']['solr_username_read'];
$GLOBALS['SiteConfiguration']['site']['columns']['solr_username_write']['config']['eval'] = '';
$GLOBALS['SiteConfiguration']['site']['columns']['solr_username_write']['displayCond'] = 'FIELD:solr_use_write_connection:=:1';

$GLOBALS['SiteConfiguration']['site']['columns']['solr_password_write'] = $GLOBALS['SiteConfiguration']['site']['columns']['solr_password_read'];
$GLOBALS['SiteConfiguration']['site']['columns']['solr_password_write']['config']['eval'] = '';
$GLOBALS['SiteConfiguration']['site']['columns']['solr_password_write']['displayCond'] = 'FIELD:solr_use_write_connection:=:1';

$GLOBALS['SiteConfiguration']['site']['columns']['solr_timeout_write'] = $GLOBALS['SiteConfiguration']['site']['columns']['solr_timeout_read'];
$GLOBALS['SiteConfiguration']['site']['columns']['solr_timeout_write']['config']['eval'] = '';
$GLOBALS['SiteConfiguration']['site']['columns']['solr_timeout_write']['displayCond'] = 'FIELD:solr_use_write_connection:=:1';

$GLOBALS['SiteConfiguration']['site']['palettes']['solr_read']['showitem'] = 'solr_scheme_read, solr_host_read, solr_port_read, solr_path_read, solr_username_read, solr_password_read, solr_timeout_read';
$GLOBALS['SiteConfiguration']['site']['palettes']['solr_write']['showitem'] = 'solr_scheme_write, solr_host_write, solr_port_write, solr_path_write, solr_username_write, solr_password_write, solr_timeout_write';
